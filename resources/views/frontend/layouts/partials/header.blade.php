                            ...
                            @if($category->subcategories->isNotEmpty())
                              <ul>
                                @foreach($category->subcategories as $subcategory)
                                  <li>
                                    <a href="{{ route('public.shop', ['category' => $subcategory->slug]) }}" class="d-flex align-items-center">
                                      @if($subcategory->image)
                                        <img src="{{ asset('storage/' . $subcategory->image) }}" alt="{{ $subcategory->name }}" style="width: 25px; height: 25px; object-fit: cover; border-radius: 50%; margin-right: 10px;">
                                      @endif
                                      {{ $subcategory->name }}
                                    </a>
                                  </li>
