                        ...
                        <div class="shop-sidebar__categories">
                            <ul class="shop-sidebar__categories-list">
                                ...
                                <li class="shop-sidebar__categories-item" style="margin-bottom: 10px;">
                                    <a href="{{ route('public.shop', ['category' => $category->slug]) }}" class="shop-sidebar__categories-link {{ request('category') == $category->slug || (isset($selectedCategory) && $selectedCategory->parent_id == $category->id) ? 'active' : '' }} d-flex align-items-center">
                                        @if($category->image)
                                    ...
                                    <ul class="shop-sidebar__subcategories-list" style="padding-left: 30px; margin-top: 10px;">
                                        ...
                                        <li class="shop-sidebar__subcategories-item" style="margin-bottom: 8px;">
                                            <a href="{{ route('public.shop', ['category' => $sub->slug]) }}" class="shop-sidebar__categories-link {{ request('category') == $sub->slug ? 'active' : '' }}" style="font-size: 14px; display: flex; align-items: center; justify-content: flex-start; gap: 8px;">
